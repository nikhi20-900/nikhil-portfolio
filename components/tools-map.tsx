...
const TOOLS_DATA: ToolItem[] = [
  // 1. BUILD
  {
    ...
    categoryLabel: "BUILD",
    status: "Used in",
    usage: "LPG Gas Leakage Dashboard & Pulse component state",
    connectedProjects: ["LPG Gas Leakage Dashboard", "Pulse (Planned)"],
  },
  {
    id: "nextjs",
    name: "Next.js",
    ...
    usage: "Pulse collaborative workspace architecture & server components",
    connectedProjects: ["Pulse (Planned)", "Web Prototypes"],
  },
  {
    id: "javascript",
    name: "JavaScript",
  ...
  },
  {
    ...
    categoryLabel: "SYSTEMS & TOOLS",
    status: "Currently exploring",
    usage: "Pulse collaborative state synchronization & presence streams",
    connectedProjects: ["Pulse (Planned)"],
  },
  {
    id: "database",
    name: "Database (SQL / Schema)",
    category: "systems",
    categoryLabel: "SYSTEMS & TOOLS",
    status: "Currently exploring",
    usage: "Pulse project storage, task persistence & activity logs",
    connectedProjects: ["Pulse (Planned)"],
  },
  {
    id: "auth",
    ...
    categoryLabel: "SYSTEMS & TOOLS",
    status: "Currently exploring",
    usage: "Pulse multi-tenant session security & team access controls",
    connectedProjects: ["Pulse (Planned)"],
  },
